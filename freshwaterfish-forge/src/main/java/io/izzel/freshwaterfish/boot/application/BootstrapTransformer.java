...
public class BootstrapTransformer extends ClassLoader {
    ...
    public BootstrapTransformer(ClassLoader appClassLoader) {
        super("freshwaterfish_bootstrap", appClassLoader);
    }

    @SuppressWarnings({"unused", "unchecked"})
    public static void onInvoke$BootstrapLauncher(String[] args, ModuleClassLoader moduleCl) {
        try {
            Class<ApplicationBootstrap> freshwaterfishBootClz = (Class<ApplicationBootstrap>) moduleCl.loadClass("io.izzel.freshwaterfish.boot.application.ApplicationBootstrap");
            Object instance = freshwaterfishBootClz.getConstructor().newInstance();
            freshwaterfishBootClz.getMethod("accept", String[].class).invoke(instance, (Object) args);
    ...
    public byte[] transformBootstrapLauncher(InputStream inputStream) throws IOException {
        ...
        var createArclightBoot = new InsnList();
        {
            ...
            var onInvoke = new MethodInsnNode(
                    ...
                    "io/izzel/freshwaterfish/boot/application/BootstrapTransformer",
