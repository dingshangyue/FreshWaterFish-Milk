...
import io.izzel.freshwaterfish.boot.asm.FreshwaterFishImplementer;
import io.izzel.freshwaterfish.forgeinstaller.ForgeInstaller;
...
public class ModBootstrap extends AbstractBootstrap {
    ...
    static void run() {
        var plugin = Launcher.INSTANCE.environment().findLaunchPlugin("freshwaterfish_implementer");
    ...
    private void injectLaunchPlugin() throws Exception {
        ...
        var plugin = new FreshwaterFishImplementer();
