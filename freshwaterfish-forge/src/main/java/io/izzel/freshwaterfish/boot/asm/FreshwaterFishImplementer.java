...
import io.izzel.freshwaterfish.boot.log.FreshwaterFishI18nLogger;
import io.izzel.freshwaterfish.boot.mod.ModBootstrap;
...
public class FreshwaterFishImplementer implements ILaunchPluginService {

    static final Logger LOGGER = FreshwaterFishI18nLogger.getLogger("Implementer");
    ...
    public FreshwaterFishImplementer() {
        this(detectTransformLogger());
    }

    public FreshwaterFishImplementer(boolean logger) {
        this.logger = logger;
    }
    ...
    @Override
    public String name() {
        return "freshwaterfish_implementer";
    }
