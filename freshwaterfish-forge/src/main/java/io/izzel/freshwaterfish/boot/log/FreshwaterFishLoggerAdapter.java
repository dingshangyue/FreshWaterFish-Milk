...
public class FreshwaterFishLoggerAdapter extends CoreLoggerAdapter {

    @Override
    protected Logger newLogger(final String name, final LoggerContext context) {
        Logger logger = super.newLogger(name, context);
        if (logger instanceof ApiLogger) {
            return new FreshwaterFishJulLogger(logger);
        } else {
            return logger;
        }
    }

    public static class FreshwaterFishJulLogger extends Logger {

        private final Logger logger;

        protected FreshwaterFishJulLogger(Logger logger) {
