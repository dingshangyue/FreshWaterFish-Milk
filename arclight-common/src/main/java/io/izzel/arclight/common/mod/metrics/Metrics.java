...
public class Metrics {
    ...
    public Metrics(String serverVersion, int serviceId, File dataFolder) {
        ...
        metricsBase =
                new MetricsBase(
                        ...
                        isFolia ? null : submitDataTask -> Bukkit.getScheduler().runTask(Bukkit.getPluginManager().getPlugins()[0], submitDataTask),
                        () -> true,
    ...
    private void appendServiceData(JsonObjectBuilder builder, String serverVersion) {
