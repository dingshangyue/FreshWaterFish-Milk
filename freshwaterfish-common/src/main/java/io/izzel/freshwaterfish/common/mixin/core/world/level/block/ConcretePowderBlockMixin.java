...
public abstract class ConcretePowderBlockMixin extends FallingBlockMixin {
    ...
    public boolean freshwaterfish$blockForm(Level world, BlockPos pos, BlockState newState, int flags) {
    ...
    public BlockState freshwaterfish$blockForm(ConcretePowderBlock instance, BlockPlaceContext context) {
    ...
    public BlockState freshwaterfish$blockForm(ConcretePowderBlock instance, BlockState stateIn, Direction facing, BlockState facingState, LevelAccessor worldIn, BlockPos currentPos, BlockPos facingPos) {
