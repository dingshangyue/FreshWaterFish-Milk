...
import io.izzel.freshwaterfish.common.mod.permission.FreshwaterFishDummyPermissible;
...
public class FreshwaterFishDummyCommandSender extends FreshwaterFishDummyPermissible implements CommandSender, Audience {

    public CommandSourceStack stack;
    public Spigot spigot;

    public FreshwaterFishDummyCommandSender(CommandSourceStack stack) {
        this.stack = stack;
    }
        ...
        public void sendMessage(@NotNull BaseComponent component) {
            try {
                ...
                if (result != null) {
                    ...
                    FreshwaterFishDummyCommandSender.this.sendMessage(adventureComponent);
                }
            } catch (Exception e) {
