...
import static io.izzel.freshwaterfish.common.mod.util.remapper.FreshwaterFishRedirectAdapter.loadInt;

// 你好
// 不要抄（笑）
@SuppressWarnings("unused")
public class FreshwaterFishEnumExtender {

    private static final Logger LOGGER = FreshwaterFishI18nLogger.getLogger("EnumExtender");
