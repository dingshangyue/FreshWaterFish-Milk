...
import io.izzel.freshwaterfish.common.bridge.core.entity.passive.FoxEntityBridge;
...
public abstract class FoxMixin extends AnimalMixin implements FoxEntityBridge {
    ...
    private boolean freshwaterfish$pickupEvent(Fox foxEntity, ItemStack stack, ItemEntity itemEntity) {
