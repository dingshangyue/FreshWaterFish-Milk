...
import io.izzel.freshwaterfish.common.bridge.bukkit.JavaPluginLoaderBridge;
...
public class PluginClassLoaderMixin extends URLClassLoader implements RemappingClassLoader {
    ...
    public FreshwaterFishRemapConfig getRemapConfig() {
        return FreshwaterFishRemapConfig.PLUGIN;
    }
    ...
    protected Class<?> findClass(String name) throws ClassNotFoundException {
        ...
        if (result == null) {
            ...
            if (url != null) {
                ...
                Product2<byte[], CodeSource> classBytes = this.getRemapper().remapClass(name, byteSource, connection, FreshwaterFishRemapConfig.PLUGIN);
