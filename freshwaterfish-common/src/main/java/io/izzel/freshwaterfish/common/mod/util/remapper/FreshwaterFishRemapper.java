...
import io.izzel.freshwaterfish.common.mod.util.remapper.patcher.FreshwaterFishPluginPatcher;
import io.izzel.freshwaterfish.common.mod.util.remapper.patcher.PluginLoggerTransformer;
import io.izzel.freshwaterfish.common.mod.util.remapper.resource.RemapSourceHandler;
...
public class FreshwaterFishRemapper {

    public static final FreshwaterFishRemapper INSTANCE;
    ...
    static {
        FreshwaterFishI18nLogger.getLogger("FreshwaterFish").info("loading-mapping");
        try {
            INSTANCE = new FreshwaterFishRemapper();
            String property = System.getProperty("freshwaterfish.remapper.dump");
            if (property != null) {
            ...
            SWITCH_TABLE_FIXER = (Function<byte[], byte[]>) Class.forName("io.izzel.freshwaterfish.boot.asm.SwitchTableFixer").getField("INSTANCE").get(null);
        } catch (Exception e) {
    ...
    public FreshwaterFishRemapper() throws Exception {
        ...
        this.toNmsMapping.loadMappings(
                new BufferedReader(new InputStreamReader(FreshwaterFishRemapper.class.getResourceAsStream("/bukkit_srg.srg"))),
                null, null, false
        );
        // TODO workaround for https://github.com/md-5/SpecialSource/pull/81
        //  remove on update
        var content = new String(FreshwaterFishRemapper.class.getResourceAsStream("/bukkit_srg.srg").readAllBytes(), StandardCharsets.UTF_8);
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(FreshwaterFishRemapper.class.getResourceAsStream("/inheritanceMap.txt")))) {
        ...
        this.transformerList.add(FreshwaterFishInterfaceInvokerGen.INSTANCE);
        this.transformerList.add(FreshwaterFishRedirectAdapter.INSTANCE);
        ...
        this.patchers = FreshwaterFishPluginPatcher.load(this.transformerList);
