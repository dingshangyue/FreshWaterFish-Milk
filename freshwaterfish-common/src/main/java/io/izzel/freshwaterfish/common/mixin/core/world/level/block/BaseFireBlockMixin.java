...
public class BaseFireBlockMixin {
    ...
    private void freshwaterfish$onFire(Entity instance, int seconds, BlockState state, Level level, BlockPos pos) {
    ...
    public boolean freshwaterfish$extinguish2(Level world, BlockPos pos, boolean isMoving) {
