...
public abstract class SimpleContainerMixin implements Container, IInventoryBridge {
    ...
    public void freshwaterfish$constructor(int numSlots) {
        throw new RuntimeException();
    }

    public void freshwaterfish$constructor(int numSlots, InventoryHolder owner) {
        this.freshwaterfish$constructor(numSlots);
