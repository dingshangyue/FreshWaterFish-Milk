...
public final class FreshwaterFishPermissionHandler implements IPermissionHandler {

    private final IPermissionHandler delegate;

    public FreshwaterFishPermissionHandler(IPermissionHandler delegate) {
    ...
    public ResourceLocation getIdentifier() {
        return new ResourceLocation("freshwaterfish", "permission");
    }
