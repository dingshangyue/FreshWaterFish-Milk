...
import io.izzel.freshwaterfish.common.bridge.core.util.IWorldPosCallableBridge;
...
public abstract class RepairContainerMixin extends ItemCombinerMixin {
    ...
    private void freshwaterfish$callInventoryEvent(ResultContainer instance, int slot, ItemStack itemStack) {
