...
public class FreshwaterFishInterfaceInvokerGen implements PluginTransformer {

    public static final FreshwaterFishInterfaceInvokerGen INSTANCE = new FreshwaterFishInterfaceInvokerGen();
            ...
            for (Map.Entry<String, String> entry : set) {
                ...
                if (node != null && !node.name.equals(name)) {
                    ...
                    if (!extend) {
                        ...
                        FreshwaterFishMod.LOGGER.debug("Generated {} redirecting to {}", classNode.name + "/" + name + " " + desc, node.owner + "/" + node.name + " " + node.desc);
                    }
                }
            }
        }
