...
import io.izzel.freshwaterfish.common.mod.util.remapper.*;
import io.izzel.freshwaterfish.common.util.Enumerations;
...
public class FreshwaterFishReflectionHandler extends ClassLoader {
    ...
    private static Class<?> tryLoadClass(String binaryName, boolean initialize, ClassLoader preferredLoader) throws ClassNotFoundException {
        ...
        loaders.add(FreshwaterFishReflectionHandler.class.getClassLoader());
    ...
    public static Object[] handleMethodInvoke(Method method, Object src, Object[] param) throws Throwable {
        Object[] ret = FreshwaterFishRedirectAdapter.runHandle(remapper, method, src, param);
        if (ret != null) {
            return ret;
        } else {
    ...
    public static Object redirectMethodInvoke(Method method, Object src, Object[] param) throws Throwable {
        Object ret = FreshwaterFishRedirectAdapter.runRedirect(remapper, method, src, param);
        if (ret != remapper) {
            return ret;
        } else {
    ...
    public static byte[] transformOrAdd(ClassLoader loader, byte[] bytes) {
        ...
        if (rcl != null) {
            ...
            FreshwaterFishRedirectAdapter.scanMethod(bytes);
            return bytes;
        }
    }
}
