package io.izzel.freshwaterfish.common.mixin.core.world.entity.monster.piglin;

import io.izzel.freshwaterfish.common.bridge.core.entity.MobEntityBridge;
import io.izzel.freshwaterfish.common.bridge.core.entity.monster.piglin.PiglinBridge;
...
public abstract class PiglinAiMixin {
    ...
    private static boolean freshwaterfish$customBarter(ItemStack stack, Piglin piglin) {
    ...
    private static void freshwaterfish$barterEvent(Piglin piglin, List<ItemStack> items) {
    ...
    private static boolean freshwaterfish$customLove(ItemStack stack, Piglin piglin) {
    ...
    private static boolean freshwaterfish$customBanter2(ItemStack stack, Piglin piglin) {
        return isBarterItem(stack, piglin);
    }

    @Redirect(method = "canAdmire", at = @At(value = "INVOKE", remap = false, target = "Lnet/minecraft/world/item/ItemStack;isPiglinCurrency()Z"))
    private static boolean freshwaterfish$customBanter3(ItemStack stack, Piglin piglin) {
        return isBarterItem(stack, piglin);
    }
    ...
    private static boolean freshwaterfish$customLove2(ItemStack stack, Piglin piglin) {
        return isLovedByPiglin(stack, piglin);
    }
}
