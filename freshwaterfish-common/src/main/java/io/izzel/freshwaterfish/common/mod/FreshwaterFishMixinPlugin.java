...
import io.izzel.freshwaterfish.common.mod.mixins.BukkitPaperApiPatcher;
import io.izzel.freshwaterfish.common.mod.mixins.ShouldApplyProcessor;
...
public class FreshwaterFishMixinPlugin implements IMixinConfigPlugin {
    ...
    private void modifyConstructor(String targetClassName, ClassNode classNode) {
        if (modifyConstructor.contains(targetClassName)) {
            ...
            for (MethodNode method : classNode.methods) {
                ...
                if (method.name.equals("freshwaterfish$constructor$override")) {
            ...
            while (iterator.hasNext()) {
                ...
                if (methodNode.name.equals("freshwaterfish$constructor")) {
                ...
                if (methodNode.name.equals("freshwaterfish$constructor$super")) {
                    iterator.remove();
                }
                if (methodNode.name.equals("<init>") && overrideCtor.contains(methodNode.desc)) {
                    iterator.remove();
                } else if (methodNode.name.equals("freshwaterfish$constructor$override")) {
                    methodNode.name = "<init>";
                    remapCtor(classNode, methodNode);
                }
            }
    ...
    private void remapCtor(ClassNode classNode, MethodNode methodNode) {
        ...
        for (AbstractInsnNode node : methodNode.instructions) {
            if (node instanceof MethodInsnNode methodInsnNode) {
                if (methodInsnNode.name.equals("freshwaterfish$constructor")) {
                    if (initialized) {
                ...
                if (methodInsnNode.name.equals("freshwaterfish$constructor$super")) {
                    if (initialized) {
                        throw new ClassFormatError("Duplicate constructor call");
                    } else {
                        methodInsnNode.setOpcode(Opcodes.INVOKESPECIAL);
