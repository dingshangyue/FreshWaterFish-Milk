...
public abstract class MinecartTNTMixin extends AbstractMinecartMixin {
    ...
    private Explosion freshwaterfish$explode(Level level, Entity entity, DamageSource source, ExplosionDamageCalculator calculator, double x, double y, double z, float radius, boolean fire, Level.ExplosionInteraction interaction, CallbackInfo ci) {
