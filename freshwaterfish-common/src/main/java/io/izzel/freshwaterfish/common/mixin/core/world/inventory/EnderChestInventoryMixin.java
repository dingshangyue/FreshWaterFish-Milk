...
public abstract class EnderChestInventoryMixin extends SimpleContainerMixin implements IInventoryBridge, Container {
    ...
    public void freshwaterfish$constructor$super(int numSlots, InventoryHolder owner) {
        throw new RuntimeException();
    }

    public void freshwaterfish$constructor(Player owner) {
        freshwaterfish$constructor$super(27, ((PlayerEntityBridge) owner).bridge$getBukkitEntity());
        this.owner = owner;
    }
