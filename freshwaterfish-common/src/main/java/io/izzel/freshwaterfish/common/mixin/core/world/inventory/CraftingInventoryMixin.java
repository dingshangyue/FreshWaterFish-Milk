...
public abstract class CraftingInventoryMixin implements CraftingInventoryBridge, Container {
    ...
    public void freshwaterfish$constructor(AbstractContainerMenu eventHandlerIn, int width, int height) {
        throw new RuntimeException();
    }

    public void freshwaterfish$constructor(AbstractContainerMenu eventHandlerIn, int width, int height, Player owner) {
        freshwaterfish$constructor(eventHandlerIn, width, height);
        this.owner = owner;
    }
