...
import io.izzel.freshwaterfish.common.bridge.core.inventory.container.SlotBridge;
...
public abstract class AbstractContainerMenuMixin implements ContainerBridge {
    ...
    public InventoryView getBukkitView() {
        if (bukkitView == null) {
            bukkitView = FreshwaterFishContainer.createInvView((AbstractContainerMenu) (Object) this);
        }
        return bukkitView;
    }
