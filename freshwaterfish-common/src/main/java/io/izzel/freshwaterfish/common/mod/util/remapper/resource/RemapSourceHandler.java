package io.izzel.freshwaterfish.common.mod.util.remapper.resource;
...
public class RemapSourceHandler extends URLStreamHandler {
    ...
    private static class RemapSourceConnection extends URLConnection {
        ...
        public void connect() throws IOException {
            ...
            this.array = FreshwaterFishRemapper.getResourceMapper().remapClassFile(bytes, GlobalClassRepo.INSTANCE);
        }
