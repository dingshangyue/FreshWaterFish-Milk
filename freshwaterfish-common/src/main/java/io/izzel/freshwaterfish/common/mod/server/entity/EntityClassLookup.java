...
public class EntityClassLookup {
    ...
    static {
        // abstract types
        add(Entity.class, new EntityClass<>(org.bukkit.entity.Entity.class, FreshwaterFishModEntity.class, FreshwaterFishModEntity::new));
        add(AbstractSkeleton.class, new EntityClass<>(org.bukkit.entity.AbstractSkeleton.class, FreshwaterFishModAbstractSkeleton.class, FreshwaterFishModAbstractSkeleton::new));
        add(Mob.class, new EntityClass<>(org.bukkit.entity.Mob.class, org.bukkit.craftbukkit.v.entity.CraftMob.class, FreshwaterFishModMob::new));
        add(AbstractMinecart.class, new EntityClass<>(org.bukkit.entity.Minecart.class, FreshwaterFishModMinecart.class, FreshwaterFishModMinecart::new));
        add(AbstractMinecartContainer.class, new EntityClass<>(org.bukkit.entity.Minecart.class, FreshwaterFishModMinecartContainer.class, FreshwaterFishModMinecartContainer::new));
        add(AbstractHorse.class, new EntityClass<>(org.bukkit.entity.AbstractHorse.class, FreshwaterFishModHorse.class, FreshwaterFishModHorse::new));
        add(AbstractChestedHorse.class, new EntityClass<>(org.bukkit.entity.ChestedHorse.class, FreshwaterFishModChestedHorse.class, FreshwaterFishModChestedHorse::new));
        add(Projectile.class, new EntityClass<>(org.bukkit.entity.Projectile.class, FreshwaterFishModProjectile.class, FreshwaterFishModProjectile::new));
        add(Raider.class, new EntityClass<>(org.bukkit.entity.Raider.class, FreshwaterFishModRaider.class, FreshwaterFishModRaider::new));
        ...
        add(ThrowableItemProjectile.class, new EntityClass<>(org.bukkit.entity.ThrowableProjectile.class, FreshwaterFishModThrowableProjectile.class, FreshwaterFishModThrowableProjectile::new));
    ...
    public static void init() {
        ...
        for (Class<?> entityClass : allEntityClasses) {
            ...
            if (optional.isEmpty()) {
                error = true;
                FreshwaterFishMod.LOGGER.error(entityClass + " has no valid entity class mapping");
            }
        }
        if (error) {
