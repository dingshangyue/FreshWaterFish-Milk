package io.izzel.freshwaterfish.gradle.tasks
...
abstract class UploadFilesTask extends DefaultTask {
    ...
    private void uploadOne(File file) {
        ...
        link("/freshwaterfish/branches/${branch.get()}/versions-snapshot/${version.get()}/${modloader}", [type: 'object', value: sha1])
        link("/freshwaterfish/branches/${branch.get()}/loaders/${modloader}/versions-snapshot/${version.get()}", [type: 'object', value: sha1])
        link("/freshwaterfish/branches/${branch.get()}/latest-snapshot", [type: 'link', value: "/freshwaterfish/branches/${branch.get()}/versions-snapshot/${version.get()}", cache_seconds: 3600])
        link("/freshwaterfish/branches/${branch.get()}/loaders/${modloader}/latest-snapshot", [type: 'link', value: "/freshwaterfish/branches/${branch.get()}/loaders/${modloader}/versions-snapshot/${version.get()}", cache_seconds: 3600])
        if (!snapshot.get()) {
            link("/freshwaterfish/branches/${branch.get()}/versions-stable/${version.get()}/${modloader}", [type: 'object', value: sha1])
            link("/freshwaterfish/branches/${branch.get()}/loaders/${modloader}/versions-stable/${version.get()}", [type: 'object', value: sha1])
            link("/freshwaterfish/branches/${branch.get()}/latest-stable", [type: 'link', value: "/freshwaterfish/branches/${branch.get()}/versions-stable/${version.get()}", cache_seconds: 86400])
            link("/freshwaterfish/branches/${branch.get()}/loaders/${modloader}/latest-stable", [type: 'link', value: "/freshwaterfish/branches/${branch.get()}/loaders/${modloader}/versions-stable/${version.get()}", cache_seconds: 86400])
        }
    }
